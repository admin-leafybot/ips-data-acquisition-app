...
import ai.indoorbrain.ui.components.FloorSelectionDialog
import ai.indoorbrain.ui.components.SessionCompleteDialog
...
fun HomeScreen(
    ...
    timeoutWarning: HomeViewModel.TimeoutWarningState?,
            ...
            Card(
                ...
                Column(
                    ...
                    if (activeSession != null) {
                        ...
                        Text(
                            text = stringResource(R.string.session_started, formatter.format(
                                Date(
